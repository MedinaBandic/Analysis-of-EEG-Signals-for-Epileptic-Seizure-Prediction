%load trainig preictal signals for patient 18
...
%files names
preseizure1channel = 'chb18_28_edfm.mat';
seizure1channel = 'chb18_29_edfm.mat';

preseizure2channel = 'chb18_29_edfm.mat';
seizure2channel = 'chb18_30_edfm.mat';

preseizure3channel = 'chb18_30_edfm.mat';
seizure3channel = 'chb18_31_edfm.mat';

preseizure4channel = 'chb18_31_edfm.mat';
seizure4channel = 'chb18_32_edfm.mat';


seizure1start = 890112; %start of seizure (3477*256Hz)
preictalSeizure1start = totalLength -(length48min - seizure1start); 

seizure2start = 138496; %start of seizure (541*256Hz)
preictalSeizure2start = totalLength -(length48min - seizure2start);

seizure3start = 534272; %start of seizure (2087*256Hz)
preictalSeizure3start = totalLength -(length48min - seizure3start);

seizure4start = 488448; %start of seizure (1908*256Hz)
preictalSeizure4start = totalLength -(length48min - seizure3start);
...
ictal_sig_4 = load(seizure4channel);
preictal_sig_4 = load(preseizure4channel);

ictal_sig_4_seizure=ictal_sig_4.val(:,1:seizure3start);
preictal_sig_4_seizure=preictal_sig_4.val(:,preictalSeizure4start:end);

ictal_signal_4=[preictal_sig_4_seizure ictal_sig_4_seizure];
signal = [];
signal = ictal_signal_4;
